    ...
    *  prevent lines from getting executed and altering the colors. */
    ...
    internal class Game
    {
        ...
        public Game(int x)
        {
            ...
            this.codewordOptions = [.. words.Program.wordsArray];
            ...
            this.MatchList = words.Program.wordsArray
                         .Where(u => u.Length == Codeword.Length)
                         .ToList();
        ...
        public void Display()
        {
            ...
            if (!DidWin() && !DidLose())
            {
                ...
                if (Codeword.Length > 9)
                    Console.WriteLine($"\n    length-{Codeword.Length}: {WordChoicesCount} of {codewordOptions.Length}");
                else
                    Console.WriteLine($"\n     length-{Codeword.Length}: {WordChoicesCount} of {codewordOptions.Length}");
        ...
        public int GetMatches(string input)
        {
            ...
            // get rid of spaces for example 'g_ab' not 'g _ a b'
    ...
    public class Program
    {
        ...
        public static void GetLengthCounts()
        {
            ...
            foreach (string x in wordsArray)
            {
                ...
                {
                    lengthError = true;
                    Console.Write("there was a size error...exiting.");
                    return;
                }
                if (x.Length == 13)
                    _13sCount++;
